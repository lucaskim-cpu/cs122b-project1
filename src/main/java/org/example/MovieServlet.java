...
//    }
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("MovieServlet: Starting DB lookup");
            ...
            Connection conn = ds.getConnection();
            System.out.println("MovieServlet: Got DB connection");

            // your SQL stuff here

            conn.close();
            System.out.println("MovieServlet: Done");

            response.setStatus(200);
        } catch (Exception e) {
            System.out.println("MovieServlet: Exception occurred");
            e.printStackTrace(); // 👈 THIS is what prints to catalina.log
            response.setStatus(500);
